...
runner.train([train_imgs, train_labs], [valid_imgs, valid_labs], num_epochs=5, log_iters=10, save_dir=r'./best_models', save_name='model_6.pickle')

_, axes = plt.subplots(1, 2)
axes.reshape(-1)
_.tight_layout()
plot(runner, axes)
plt.savefig('./figs/model_6.png', dpi=300, bbox_inches='tight')